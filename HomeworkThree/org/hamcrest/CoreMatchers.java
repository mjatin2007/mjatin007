...
public class CoreMatchers {
    ...
    public static /* varargs */ <T> Matcher<T> allOf(Matcher<? super T> ... matchers) {
        return AllOf.allOf(matchers);
    }
    ...
    public static /* varargs */ <T> AnyOf<T> anyOf(Matcher<? super T> ... matchers) {
        return AnyOf.anyOf(matchers);
    }
    ...
    public static /* varargs */ <T> Matcher<T> describedAs(String description, Matcher<T> matcher, Object ... values) {
    ...
    public static /* varargs */ <T> Matcher<Iterable<T>> hasItems(T ... items) {
        return IsCollectionContaining.hasItems(items);
    }

    public static /* varargs */ <T> Matcher<Iterable<T>> hasItems(Matcher<? super T> ... itemMatchers) {
